...
public class Shift {
	...
	/** addUser
	*<p> desc:</p> This method is responsible for coding the turn, 
	...
	*
	*@return this method returns a type data String whit the status of 
	*the shift
	*/
	...
	/** setStatus
	*<p> desc:</p> This method allows you to modify an attribute 
	*of the object	
	...
	*<p> desc:</p> This method allows to obtain private data
	*
	*@return this method returns a type data String whit the document 
	*the comment of the turn referring to whether the user was or not
	*/
